...
export const allPrizes: Prize[][] = [
  ...
  [
    ...
    { id: 's2-2', stationId: 2, name: 'Cardenal Guajiro2', imageUrl: '/prizes/Cardenal_de_lado.png' },
    ...
    { id: 's2-5', stationId: 2, name: 'Cardenal Guajiro1', imageUrl: '/prizes/De_frente.png' },
  ...
  // Station 6 Prizes
  [
    { id: 's6-1', stationId: 6, name: 'Cardenal Guajiro2', imageUrl: '/prizes/Cardenal_de_lado.png' },
  ...
  [
    ...
    { id: 's7-5', stationId: 7, name: 'Cardenal Guajiro1', imageUrl: '/prizes/De_frente.png' },
  ...
  [
    ...
    { id: 's8-2', stationId: 8, name: 'Cardenal Guajiro2', imageUrl: '/prizes/Cardenal_de_lado.png' },
