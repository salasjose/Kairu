...
const challenges = {
  visit: {
    ...
    description:
      "Sube un video de tu visita a un negocio verde local y comparte el enlace.",
    icon: Store,
    imageId: "green-business-visit",
    type: "video",
  },
  purchase: {
    title: "Compra de Producto Sostenible",
    description:
      "Compra un producto de un negocio verde y sube 4 fotos del artículo y la tienda.",
    icon: ShoppingCart,
    imageId: "green-business-product",
    type: "photo",
  },
};
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center w-full">
          ...
          <div className="mt-4 max-w-md mx-auto">
            <p className="bg-background/80 p-4 rounded-md text-center">
              Interactúa con negocios verdes locales completando uno de los
              siguientes retos.
            </p>
          </div>
