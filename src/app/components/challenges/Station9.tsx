  ...
  return (
    <>
      ...
      >
        ...
        {chosenScenario && (
          <div className="absolute inset-0 flex items-center justify-center z-20 p-0">
            <div
              ref={canvasRef}
              className="relative w-screen h-auto aspect-[16/9] bg-transparent rounded-none overflow-hidden shadow-xl"
            >
