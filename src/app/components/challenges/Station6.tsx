...
const challenges = {
  strategy: {
    ...
    description:
      "Crea un video explicando una estrategia de marketing para un producto reciclado o circular y pega la URL aquí.",
    icon: Film,
    imageId: "circular-economy-product",
  },
  visit: {
    title: "Video de Visita a Negocio Verde",
    description:
      "Crea un video sobre una visita a un negocio verde en tu ciudad, mostrando sus prácticas circulares, y pega la URL aquí.",
    icon: Building2,
    imageId: "green-business",
  },
};
      ...
      <div className="w-full">
        ...
        <Card className="text-center w-full shadow-lg">
          <CardContent className="p-6">
            ...
            <Image
              src={imageInfo?.imageUrl ?? "https://picsum.photos/seed/placeholder/400/300"}
              alt={imageInfo?.description ?? challenge.description}
              width={400}
              height={300}
              className="rounded-lg border-4 border-white shadow-md mx-auto mb-6 w-full max-w-sm h-auto"
              data-ai-hint={imageInfo?.imageHint ?? "image"}
            />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center w-full">
                ...
                >
                  <Card className="w-60 md:w-64 h-auto bg-card/80 backdrop-blur-sm hover:bg-card/95 transition-colors">
                    <CardContent className="flex flex-col items-center justify-center text-center p-4 h-full">
                      ...
                      <h2 className="font-bold font-headline text-lg md:text-xl text-primary">
                        {challenge.title}
                      </h2>
                    </CardContent>
                  </Card>
          ...
          <div className="mt-4 max-w-md mx-auto">
            <p className="bg-background/80 p-4 rounded-md text-center">
              Muestra tu comprensión de los principios de la economía circular
              completando uno de los retos de video.
            </p>
          </div>
